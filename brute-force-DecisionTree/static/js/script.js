// ==========================================================================
// DECISION TREE BRUTE FORCE DETECTION SYSTEM
// JavaScript untuk handling interaksi UI & Auto-Refresh Data Klasifikasi
// ==========================================================================

console.log("Decision Tree ML Detection System Loaded");
  ...
  showUnblockMessage() {
    if (this.countdownElement) {
      this.countdownElement.innerHTML =
        '<span style="color: #10b981;">✓ Model Mengevaluasi Kembali: Akses Dibuka</span>';
    }
  },
};
...
// ==========================================================================
const Dashboard = {
  refreshInterval: 15000, // Dipercepat ke 15 detik agar saat demo data log ML langsung ter-refresh cepat
  autoRefreshTimer: null,

  init() {
    console.log("Dashboard ML initialized");
  ...
  setupAutoRefresh() {
    this.autoRefreshTimer = setInterval(() => {
      console.log("Auto-refreshing Machine Learning dashboard...");
      this.refreshStats();
      this.refreshLogs();
  ...
  async refreshStats() {
    try {
      ...
      // Ambil username murni dari elemen strong dashboard
      ...
      console.log("ML Stats refreshed:", stats);
    } catch (error) {
  ...
  async refreshLogs() {
    try {
      ...
      const tbody = document.querySelector("table tbody"); // Sinkron dengan selektor HTML baru kita
      if (!tbody) return;
      ...
      console.log("ML Activity Logs refreshed");
    } catch (error) {
...
const LoginStateAnimation = {
  ...
  setupFormAnimation() {
    ...
    form.addEventListener("submit", () => {
      ...
      if (button) {
        button.innerHTML =
          '<span>Mengklasifikasikan Data...</span><span class="btn-icon">⏳</span>';
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  console.log("All Decision Tree components initialized successfully");
});
